  ...
  return (
    <div className="min-h-screen w-full bg-[#F7F5F0] text-[#1A221E] font-sans antialiased selection:bg-[#1C2826] selection:text-[#E2D8C3]">
      ...
      <main className="pt-28 pb-20 px-6 sm:px-12 lg:px-20 max-w-7xl mx-auto min-h-[calc(100vh-80px)] flex flex-col justify-center">
        <div className="bg-[#EFECE6] border border-[#E0DBCF] p-6 sm:p-10 lg:p-12 rounded-sm shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 relative h-80 sm:h-96 rounded-sm overflow-hidden border border-[#DCD6C8]">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#F7F5F0]/95 backdrop-blur-md p-6 rounded-md border border-[#E0DBCF] shadow-lg max-w-xs w-[90%] text-center">
                <div className="w-8 h-8 rounded-full bg-[#1C2826] text-white flex items-center justify-center mx-auto mb-3">
